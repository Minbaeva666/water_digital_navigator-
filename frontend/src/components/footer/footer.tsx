...
const AppFooter: React.FC = () => {
  ...
  return (
    <Footer
      ...
      role="contentinfo"
      aria-label="Fußbereich mit rechtlichen Informationen"
    >
      <nav className="footer-nav" aria-label="Rechtliche Links">
        <Space
          size={isMobile ? 12 : 20}
          wrap
          aria-label="Primäre Footer-Navigation"
        >
          ...
          <NavLink to="/barrierefreiheit" className="footer-link">
            Barrierefreiheit
          </NavLink>
          <NavLink to="/nutzungsbedingungen" className="footer-link">
            Nutzungsbedingungen
          </NavLink>
        ...
        <Typography.Text className="footer-copy">
          © {new Date().getFullYear()} Institut für nachhaltige Wassersysteme
          (inwa)
        </Typography.Text>
      </nav>
    </Footer>
