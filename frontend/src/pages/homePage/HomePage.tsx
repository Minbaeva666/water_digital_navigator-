...
const HomePage: React.FC = () => {
    ...
    const [taxonomyIndex, setTaxonomyIndex] =
                ...
                <Row justify="start" align="middle">
                    ...
                    >
                        <div>
                            ...
                            <Paragraph>
                                Dieses Portal bietet eine Vielzahl von Schnittstellen zur Digitalisierung
                                der Wasserwirtschaft. Entdecke den Digital Atlas, reiche eigene Lösungen
                                ein und mehr.
                            </Paragraph>
                            <Button
                                type="primary"
            ...
            <section className="band">
                <div className="page-container">
                    <Row justify="space-between" className="atlas-title" align="middle">
                        <Col>
                            <Title level={2} style={{margin: 0}}>Aus dem Digital Atlas</Title>
                        </Col>
                    </Row>
                    {loadingPreview ? (
                        ...
                        <Paragraph type="secondary">Aktuell sind noch keine Lösungen verfügbar.</Paragraph>
                    ) : (
